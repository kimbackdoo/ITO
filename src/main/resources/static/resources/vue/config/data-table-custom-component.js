var DataTableCustomComponent = Vue.component("data-table-coustom-component", async function (resolve) { resolve({
        "template": (await axios.get("/vue/component/common/data-table-custom-component.html")).data,
        "props": {
            "headers": {
                "type": Object,
                "default": {

...
public class RoleMenuService {
    ...
    public PageResponse<RoleMenuEntity> getRoleMenuList(
            @Valid RoleMenuParamDto roleMenuParamDto,
    ...
    @Validated (value = {ReadValidationGroup.class})
    @Transactional (readOnly = true)
    public RoleMenuEntity getRoleMenu(
    ...
    public List<RoleMenuEntity> createRoleMenuList(
            @Valid @NotEmpty (groups = {CreateValidationGroup.class}) List<@NotNull (groups = {CreateValidationGroup.class}) RoleMenuEntity> roleMenuList) {
    ...
    public List<RoleMenuEntity> modifyRoleMenuList(
            @Valid @NotEmpty (groups = {ModifyValidationGroup.class}) List<@NotNull (groups = {ModifyValidationGroup.class}) RoleMenuEntity> roleMenuList) {
        return roleMenuRepository.saveAll(roleMenuList);
    }
    ...
    @Transactional
    public void removeRoleMenuList(
            @Valid @NotEmpty (groups = {RemoveValidationGroup.class}) List<@NotNull (groups = {RemoveValidationGroup.class}) RoleMenuEntityId> roleMenuEntityIdList) {

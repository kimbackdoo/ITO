...
import kr.co.metasoft.ito.api.common.mapper.ApiMapper;
import kr.co.metasoft.ito.api.common.repository.ApiRepository;
...
public class ApiService {
    ...
    public PageResponse<ApiEntity> getApiList(
            @Valid ApiParamDto apiParamDto,
    ...
    @Transactional
    public List<ApiEntity> createApiList(
            @Valid @NotEmpty (groups = {CreateValidationGroup.class}) List<@NotNull (groups = {CreateValidationGroup.class}) ApiEntity> apiList) {
    ...
    public ApiEntity createApi(
            @Valid @NotNull (groups = {CreateValidationGroup.class}) ApiEntity apiEntity) {
        return apiRepository.save(apiEntity);
    }

    @Validated (value = {ModifyValidationGroup.class})
    @Transactional
    public List<ApiEntity> modifyApiList(
            @Valid @NotEmpty (groups = {ModifyValidationGroup.class}) List<@NotNull (groups = {ModifyValidationGroup.class}) ApiEntity> apiList) {
        return apiRepository.saveAll(apiList);
    }
    ...
    public ApiEntity modifyApi(
            @Valid @NotNull (groups = {ModifyValidationGroup.class}) ApiEntity apiEntity) {
        return apiRepository.save(apiEntity);
    }

    @Validated (value = {RemoveValidationGroup.class})
    @Transactional
    public void removeApiList(

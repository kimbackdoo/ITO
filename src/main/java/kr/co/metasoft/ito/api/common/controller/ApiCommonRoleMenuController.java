...
import kr.co.metasoft.ito.api.common.dto.RoleMenuDto;
...
import kr.co.metasoft.ito.api.common.service.RoleMenuService;
...
public class ApiCommonRoleMenuController {
    ...
    public PageResponse<RoleMenuEntity> getRoleMenuList(
            @ModelAttribute RoleMenuParamDto roleMenuParamDto,
    ...
    public List<RoleMenuEntity> createRoleMenuList(
            @RequestBody List<RoleMenuDto> roleMenuDtoList) {
    ...
    public void removeRoleMenuList(
            @RequestBody List<RoleMenuEntityId> roleMenuEntityIdList) {

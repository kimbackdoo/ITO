...
public class RoleUserService {
    ...
    public PageResponse<RoleUserEntity> getRoleUserList(
            @Valid RoleUserParamDto roleUserParamDto,
    ...
    public List<RoleUserEntity> createRoleUserList(
            @Valid @NotEmpty (groups = {CreateValidationGroup.class}) List<@NotNull (groups = {CreateValidationGroup.class}) RoleUserEntity> roleUserList) {
    ...
    public List<RoleUserEntity> modifyRoleUserList(
            @Valid @NotEmpty (groups = {ModifyValidationGroup.class}) List<@NotNull (groups = {ModifyValidationGroup.class}) RoleUserEntity> roleUserList) {
        return roleUserRepository.saveAll(roleUserList);
    }
    ...
    public void removeRoleUserList(
            @Valid @NotEmpty (groups = {RemoveValidationGroup.class}) List<@NotNull (groups = {RemoveValidationGroup.class}) RoleUserEntityId> roleUserEntityIdList) {

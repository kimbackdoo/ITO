...
public class PageResponseDto<T> {
    ...
    public PageResponseDto(Integer page, Integer rowSize, Integer pageSize, Integer totalRows) {
        if (page == null) { page = 1; }
        this.page = (page < 1) ? 1 : page;
        if (rowSize == null) { rowSize = 10; }
        ...
        this.pageEnd = (this.totalPages < (this.pageStart + this.pageSize) - 1) ? this.totalPages : ((this.pageStart + this.pageSize) - 1);
    ...
    public PageResponseDto(PageRequestDto pageRequestDto, Integer totalRows) {
        this(pageRequestDto.getPage(),
                pageRequestDto.getRowSize(),

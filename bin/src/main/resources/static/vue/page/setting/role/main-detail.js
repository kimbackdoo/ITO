        ...
        "methods": {
                    ...
                    return new Promise(function (resolve, reject) {
                        Promise.resolve()
                            .then(function () {
                                ...
                                return ito.api.common.roleMenu.getRoleMenuList(param);
                            })
            ...
            "setRoleDeatil": async function (queryId) {
                ...
                return new Promise(function (resolve, reject) {
                    Promise.resolve()
                        .then(function () {
                            return  ito.api.common.role.getRole(queryId);
                        })
                        .then(function (response) {
                ...
                return new Promise(function (resolve, reject) {
                    Promise.resolve()
                        .then(function () {
                            ...
                            return ito.api.common.api.getApiList(param);
                        })
                        .then(function (response) {
                            ...
                            if(queryId != undefined && queryId != null)
                            {
                                ...
                                return ito.api.common.roleApi.getRoleApiList(param);
                            } else {
                                return null;
                            }
                        })
            ...
            "registerNewRole" : async function () {
                ...
                {
                    await ito.alert("권한명을 반드시 입력하세요.");
                    return;
                }
                ...
                if (await ito.confirm("저장 하시겠습니까?")) {
                    ...
                    new Promise(function (resolve, reject) {
                        Promise.resolve()
                            .then(function () {
                                return ito.api.app.RoleAndRoleMenuAndRoleApi.createRoleAndRoleMenuAndRoleApi(params);
                            })
                            .then(function () { resolve(); });
                    });
            ...
            "updateRole" : async function () {
                ...
                if (await ito.confirm("수정 하시겠습니까?")) {
                    ...
                    new Promise(function (resolve, reject) {
                        Promise.resolve()
                            .then(function () {
                                 return ito.api.app.RoleAndRoleMenuAndRoleApi.modifyRoleAndRoleMenuAndRoleApi(params);
                            })
                            .then(function () { resolve(); });
                    });
